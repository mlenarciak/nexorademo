...
async function main() {
  ...
  const amenities = await prisma.amenity.createMany({
    data: [
      ...
      {
        name: "Desk",
        i18nKey: "amenity.desk",
        category: "ROOM_FEATURES",
        icon: "desk",
      },
      {
        name: "Wardrobe",
        i18nKey: "amenity.wardrobe",
        category: "ROOM_FEATURES",
        icon: "wardrobe",
      },
      ...
      // Bathroom
      {
        ...
        i18nKey: "amenity.private_bathroom",
        category: "BATHROOM",
        icon: "bath",
      },
      {
        name: "Shower",
        i18nKey: "amenity.shower",
        category: "BATHROOM",
        icon: "shower",
      },
      {
        name: "Bathtub",
        i18nKey: "amenity.bathtub",
        category: "BATHROOM",
        icon: "bathtub",
      },
      {
        name: "Hairdryer",
        i18nKey: "amenity.hairdryer",
        category: "BATHROOM",
        icon: "hairdryer",
      },
      {
        name: "Toiletries",
        i18nKey: "amenity.toiletries",
        category: "BATHROOM",
        icon: "bottle",
      },
      ...
      {
        name: "Mini Fridge",
        i18nKey: "amenity.minifridge",
        category: "KITCHEN",
        icon: "fridge",
      },
      {
        name: "Coffee Maker",
        i18nKey: "amenity.coffee",
        category: "KITCHEN",
        icon: "coffee",
      },
      {
        name: "Kettle",
        i18nKey: "amenity.kettle",
        category: "KITCHEN",
        icon: "kettle",
      },
      ...
      {
        name: "Safe",
        i18nKey: "amenity.safe",
        category: "SAFETY",
        icon: "lock",
      },
      {
        name: "Smoke Detector",
        i18nKey: "amenity.smoke_detector",
        category: "SAFETY",
        icon: "alert",
      },
      {
        name: "Fire Extinguisher",
        i18nKey: "amenity.fire_extinguisher",
        category: "SAFETY",
        icon: "fire",
      },
      ...
      {
        name: "Garden View",
        i18nKey: "amenity.garden_view",
        category: "OUTDOOR",
        icon: "tree",
      },
      {
        name: "Sea View",
        i18nKey: "amenity.sea_view",
        category: "OUTDOOR",
        icon: "waves",
      },
    ],
  ...
  const catStandardDouble = await prisma.roomCategory.create({
    data: {
      ...
      shortName: "STD DBL",
      description:
        "Comfortable double room with modern amenities and city view",
      minCapacity: 1,
      maxCapacity: 2,
      extraCapacity: 1,
      ...
      photos: [
        {
          url: "/images/rooms/standard-double-1.jpg",
          alt: "Standard Double Room",
        },
        {
          url: "/images/rooms/standard-double-2.jpg",
          alt: "Standard Double Bathroom",
        },
      ],
    },
  });
  ...
  const catDeluxeSuite = await prisma.roomCategory.create({
    data: {
      ...
      shortName: "DLX STE",
      description:
        "Spacious suite with separate living area, balcony, and stunning views",
      minCapacity: 2,
      maxCapacity: 4,
      extraCapacity: 2,
      ...
      photos: [
        ...
        {
          url: "/images/rooms/deluxe-suite-2.jpg",
          alt: "Deluxe Suite Bedroom",
        },
        {
          url: "/images/rooms/deluxe-suite-3.jpg",
          alt: "Deluxe Suite Balcony",
        },
      ],
  ...
  const catFamily = await prisma.roomCategory.create({
    data: {
      ...
      shortName: "FAMILY",
      description:
        "Perfect for families with children, featuring bunk beds and play area",
      minCapacity: 2,
      maxCapacity: 6,
      extraCapacity: 0,
      ...
      color: "#10B981",
      order: 3,
      photos: [{ url: "/images/rooms/family-room-1.jpg", alt: "Family Room" }],
    },
  });
  ...
  const balconyAmenity = allAmenities.find(
    (a) => a.i18nKey === "amenity.balcony"
  );
  const bathtubAmenity = allAmenities.find(
    (a) => a.i18nKey === "amenity.bathtub"
  );
  ...
  if (wifiAmenity && acAmenity && tvAmenity) {
    await prisma.categoryAmenity.createMany({
      data: [
        ...
        ...(balconyAmenity
          ? [{ categoryId: catDeluxeSuite.id, amenityId: balconyAmenity.id }]
          : []),
        ...(bathtubAmenity
          ? [{ categoryId: catDeluxeSuite.id, amenityId: bathtubAmenity.id }]
          : []),
